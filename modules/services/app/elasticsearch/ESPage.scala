 ...
 */
case class ESPage(pager: Pager, resp: SearchResponse) extends PageLike {
...
object ESPage {
   ...
   */
  implicit def writableOf_SearchHits(implicit codec: Codec): Writeable[ESPage] = {
   ...
   */
  implicit def contentTypeOf_SearchHits(implicit codec: Codec): ContentTypeOf[ESPage] =
    ContentTypeOf[ESPage](Some(ContentTypes.JSON))
